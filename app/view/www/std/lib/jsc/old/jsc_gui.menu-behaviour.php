...
function setMenuBehaviour(classPrefix, elementType)
{
  elementType = (elementType == null ? 'div' : elementType);
  var prefix = new RegExp('^'+classPrefix,'gi');
  for(var i=0; (ref = document.getElementsByTagName(elementType)[i]) != null; i++)
  {
    if(ref.className.match(prefix))
    {
